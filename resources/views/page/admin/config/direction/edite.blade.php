    ...
    <div class="col-md-8">
        ...
        <div class="card overflow-hidden">
            <div class="card-heading bg-primary">
                <h3 class="card-title text-white">Modifier une direction</h3>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                <input type="text" name="libelle" class="form-control" placeholder="Libelle de la direction" value="{{ old('libelle') ? old('libelle') : $direction->libelle }}" required>
