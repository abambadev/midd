    ...
    <div class="col-md-8">
        ...
        <div class="card overflow-hidden">
            <div class="card-heading bg-primary">
                <h3 class="card-title text-white">Ajouter une inspection</h3>
            </div>
            <div class="card-body p-2 text-center">
                ...
                <form method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <select name="dren_id" class="form-control" id="input_dren_id" required>
									@foreach ( $directions as $value)
									    <option @if (old('dren_id') == $value->id ) selected @endif value="{{ $value->id }}">{{ $value->libelle }}</option>
									@endforeach
                                </select>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                <input type="text" name="libelle" class="form-control" placeholder="Libelle de l'inspection" value="{{ old('libelle') }}" required>
