...
<tbody>
<tr>
<td style="font-size: 30px; text-align: center; width: 600px;">
<p>R&eacute;initialisation de mot de passe</p>
</td>
</tr>
</tbody>
</table>
<table class="force-full-width" style="margin: 0px auto; height: 462px;" cellspacing="0" cellpadding="0" bgcolor="#4dbfbf">
<tbody>
<tr style="height: 262px;">
<td style="height: 220px; width: 220px;"><br /><img src="{{ asset('/file/image/password-reset.png') }}" alt="robot picture" width="220" height="220" /></td>
</tr>
...
<p>Ce mail fait suite &agrave; une demande de r&eacute;initialisation de mot de passe</p>
</td>
</tr>
</tbody>
</table>
...
<div><!-- [if mso]>
                        <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="http://" style="height:50px;v-text-anchor:middle;width:200px;" arcsize="8%" stroke="f" fillcolor="#178f8f">
                          <w:anchorlock/>
                          <center>
                        <![endif]--> <a style="background-color: #178f8f; border-radius: 4px; color: #ffffff; display: inline-block; font-family: Helvetica, Arial, sans-serif; font-size: 16px; font-weight: bold; line-height: 50px; text-align: center; text-decoration: none; width: 200px; -webkit-text-size-adjust: none;" title="R&eacute;initialiser maintenant" href="{{ $_reset_url }}" target="_blank" rel="noopener">R&eacute;initialiser maintenant</a> <!-- [if mso]>
                          </center>
                        </v:roundrect>
                      <![endif]--></div>
<br /><br /></td>
